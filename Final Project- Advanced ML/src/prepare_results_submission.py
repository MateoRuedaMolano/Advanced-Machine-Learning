...
def save_seq_results(model_name,seq_name,prev_mask):
    ...
    prev_obj_ids = []
    prev_assignment = []
    images_dir = os.path.join('../../databases/YouTubeVOS/valid/JPEGImages/', seq_name)
    ...
    for frame_name in frame_names:
        ...
        if frame_idx == 0:
            ...
            annotation = np.array(Image.open('../../databases/YouTubeVOS/valid/Annotations/' + seq_name + '/' + frame_name + '.png'))
...
if __name__ == "__main__":
    ...
    parser.add_argument('-model_name', dest='model_name', default='youtube_gru_1r_prueba_prev_mask')
    parser.add_argument('--prev_mask', dest='prev_mask', action='store_true')
    parser.set_defaults(prev_mask=True)
