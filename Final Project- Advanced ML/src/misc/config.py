...
__C.PATH.SEQUENCES = osp.join(__C.PATH.DATA,"JPEGImages",__C.RESOLUTION) #Images
#__C.PATH.SEQUENCES = osp.join(__C.PATH.DATA,"OpticalFlow",__C.RESOLUTION) #Optical Flow
